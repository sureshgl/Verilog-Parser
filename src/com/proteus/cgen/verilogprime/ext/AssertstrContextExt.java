...
import com.proteus.cgen.verilogprime.gen.VerilogPrimeParser.AssertstrContext;

public class AssertstrContextExt extends AbstractBaseExt{

	@Getter private AssertstrContext ctx;
	...
	public void setContext(ParserRuleContext ctx){
		if(ctx != null){
			if(ctx instanceof AssertstrContext){
				this.ctx = (AssertstrContext) ctx;
			} else {
				throw new ClassCastException(ctx.getClass().getSimpleName() + " cannot be cased to "+AssertstrContext.class.getName());
			}
		} else {
			this.ctx= null;
		}
